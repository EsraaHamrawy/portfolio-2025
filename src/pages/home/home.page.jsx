...
const Home = () => {
  ...
  return (
    <>
          ...
          <Grid item xs={12} md={6} className={style.heroText}>
            ...
            <div className={`${style.fadeInUp} ${style.delay600}`}>
              ...
              <p className={style.smallResume}>
                ...
                building production-ready web applications with React.js
                and Next.js. I turn complex requirements into scalable,
                high-quality interfaces through reusable architecture,
                efficient state management, responsive UI, and seamless
                API integration.
      ...
      {/* Skills */}
      <section
        className={`${style.container} ${style.fadeInUp} ${style.delay1000}`}
        id="skills"
      ...
      >
        ...
        <div
          className={`${style.skilscontainer} ${style.delay1000}`}
        >
          <p className={style.smallResume}>
            These are the{" "}
            <span className={style.colorText}>
            ...
            products that feel clear, fast, and easy to use.
          </p>
        </div>
